...
To quantify the set of features commonly used in serverless applications, we analyzed publicly available lambda programs submitted by real users to the AWS Serverless Application Repository\footnote{https://serverlessrepo.aws.amazon.com/applications}. We found
